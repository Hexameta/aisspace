...
<body>
    ...
    <?php
    $query = "SELECT * FROM newsfeed WHERE news_event = 2 and n_status=1 ORDER BY id DESC LIMIT 3";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        <div class="mb-2 mt-60 pt-2">
            ...
            <div class="logo-carousel-wrap py-20">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div role="button"
                        ...
                        data-toggle="modal" style="width:300px" data-target="#edit"
                        onclick='setModalData("Event", <?php echo htmlspecialchars($img, ENT_QUOTES, 'UTF-8'); ?>, <?php echo htmlspecialchars($title, ENT_QUOTES, 'UTF-8'); ?>, <?php echo htmlspecialchars($date, ENT_QUOTES, 'UTF-8'); ?>, <?php echo htmlspecialchars($desc, ENT_QUOTES, 'UTF-8'); ?>)'>
            ...
            <div class="d-grid gap-2 col-4  col-md-1 mx-auto">
                <a href="./events/" class="btn btn-primary">See More</a>
            </div>
        </div>
        <?php
    }
            ...
            <div class="row justify-content-between align-items-center mb-40">
                <div class="col-lg-6 wow fadeInLeft delay-0-2s">
                    <div class="section-title mb-35">
                        ...
                        <p class="text-justify">Entrepreneurship is essential for economic growth and poverty
                            reduction,
                            as it creates
                ...
                <div class="col-lg-5 wow fadeInRight delay-0-2s">
                    ...
                    <p class="text-justify">We are passionate about supporting bold and innovative entrepreneurs who
                        are
                        developing
                ...
                <div class="col-lg-6">
                    <div class="about-content pl-70 rpl-0 wow fadeInRight delay-0-2s">
                        ...
                        <ul class="list-style-three mt-15">
                            ...
                            <li class="text-justify">To provide financial and technical support to aspiring both
                                faculty
                                and students
                                innovators and entrepreneurs in the campus.</li>
                            <li class="text-justify">To facilitate in market augmentation for the products developed
                                by
                                the start-ups
                                in the campus.</li>
