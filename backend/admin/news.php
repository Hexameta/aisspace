            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">News Feed</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">News Feed</h6>
                </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <div
                                class="d-flex bg-gradient-primary text justify-content-between border-radius-lg pt-3 p-3">
                                ...
                                <button class="btn bg-gradient-dark m-0 toast-btn" type="button" data-toggle="modal"
                                    data-target="#form"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add New Item</button>
                            </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                                                style="width: 10%;">
                                                Date</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 th-sm"
                                                style="width: 50%;">
                                                Description</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                                                style="width: 10%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="align-middle text-center">
                                                <h6 class="mb-0 text-xs font-weight-bolder mx-3">
                                                Entrepreneurial Exibition Stalls - Part of Incubation Inaugration
                                                </h6>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-sm font-weight-bolder">12/10/2021</span>
                                            </td>
                                            <td class="align-middle text-sm">
                                                <p class="text-xs font-weight-bold mb-0 p-4">
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <img src="../../assets/images/news/news1.png" alt=""
                                                    height="100" width="100" style="object-fit: contain;"
                                            ...
                                            <td class="align-middle text-center">
                                                ...
                                                <br>
                                                <a class="btn btn-link text-dark px-3 mb-0" data-toggle="modal"
                                                    data-target="#edit"><i class="fas fa-pencil-alt text-dark me-2"
                                ...
                                <div class="card card-blog card-plain">
                                    ...
                                    <div class="card-body px-1 pb-0">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <button type="button" class="btn btn-outline-primary btn-sm mb-0">Delete
                                                News</button>
                                            <buttone type="button" class="btn btn-primary btn-sm mb-0"
                            ...
                            <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                                <div class="card h-100 card-plain border">
                                    <div class="card-body d-flex flex-column justify-content-center text-center">
                                        <a type="button" data-toggle="modal" data-target="#form">
