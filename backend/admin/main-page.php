                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-end">
                                <a class="btn btn-link text-dark px-3 mb-0" data-toggle="modal" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Edit Profile" data-target="#edit"><i class="fas fa-pencil-alt me-2"></i> Edit</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-auto my-auto">
                <div class="h-100">
                    <div class="card-header pb-0 p-3">
                        <div class="row">
                            <div class="col-md-8 align-items-center">
                                <h6 class="mb-0">Main Page Data</h6>
                            </div>
                            <div class="col-md-4 text-end">
                                <a class="btn btn-link text-dark px-3 mb-0" data-toggle="modal" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Edit Main Page" data-target="#data"><i
                    ...
                    <form action="includes/editadmin.php" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-2" id="user" name="user"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-2" id="password" name="password"
        ...
        <div class="modal fade" id="data" tabdashboard="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="includes/editdata.php" method="POST">

                        <div class="modal-body">
                            <input type="hidden" name="id" id="id">
                            <div class="form-group">
                                <label for="mobile">Mobile Number</label>
                                <input type="text" class="form-control p-2" id="mobile" name="mobile"
                                    placeholder="Enter Mobile Number">
                            </div>
                            <div class="form-group">
                                <label for="email1">Email</label>
                                <input type="email" class="form-control p-2" id="email1" name="email1"
                                    placeholder="Enter Email">
                            </div>
                        </div>
                        <div class=" modal-footer border-top-0 d-flex justify-content-center">
