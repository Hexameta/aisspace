                ...
                <table class="align-items-center mb-0 w-100 d-block d-md-table">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                        ...
                        Website</th>
                      <th
                        class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 th-sm"
                        style="width: 50%;">
                        Description</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                        style="width: 10%;">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <a class="text-xs font-weight-bolder mb-0" href="https://hexameta.in"
                          target="_blank">https://hexameta.in</a>
                      </td>
                      ...
                      <td class="align-middle text-center text-sm">
                        <img src="../../assets/images/companies/hexameta.png" alt="" height="100" width="100"
                          style="object-fit: contain;" data-toggle="modal" data-target="#view">
                      </td>
                      <td class="align-middle text-center">
                        ...
                        <br>
                        <a class="btn btn-link text-dark px-3 mb-0" data-toggle="modal" data-target="#edit"><i
